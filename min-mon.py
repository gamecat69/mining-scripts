...
def writeHTML():
	...
	file = string.replace(data, '$minername', str(cfg["MINERNAME"]))
	file = string.replace(data, '$lastupdate', str(data[lastupdate]))
	file = string.replace(data, '$systemuptime', str(data['systemuptime']))
	file = string.replace(data, '$avggputemp', str(data['avggputemp']))
	file = string.replace(data, '$avggpufanspeed', str(data['avggpufanspeed']))

	file = string.replace(data, '$ethusd', str(data['ethusd']))
	file = string.replace(data, '$ethhashrate', str(data['ethhashrate']))
	file = string.replace(data, '$ethshares', str(data['ethsharesperhour']))
	file = string.replace(data, '$ethuptime', str(data['ethuptime']))
	file = string.replace(data, '$ethtotalshares', str(data['ethtotalshares']))
	file = string.replace(data, '$ethpool', str(data['ethpool']))

	file = string.replace(data, '$xmrusd', str(data['xmrusd']))
	file = string.replace(data, '$xmrhashrate', str(data['xmrhashrate']))
	file = string.replace(data, '$xmrshares', str(data['xmrsharesperhour']))
	file = string.replace(data, '$xmruptime', str(data['xmruptime']))
	file = string.replace(data, '$xmrtotalshares', str(data['xmrtotalshares']))
	file = string.replace(data, '$xmrpool', str(data['xmrpool']))
	file = string.replace(data, '$numGPU', str(data['numGPU']))
	file = string.replace(data, '$avggpuhashrate', str(data['avggpuhashrate']))

	file = string.replace(data, '$btcpusd', str(data['btcpusd']))
	file = string.replace(data, '$btcphashrate', str(data['btcphashrate']))
	file = string.replace(data, '$btcpshares', str(data['btcpshares']))
	file = string.replace(data, '$btcpuptime', str(data['btcpuptime']))
	file = string.replace(data, '$btcptotalshares', str(data['btcptotalshares']))
	file = string.replace(data, '$btcppool', str(data['btcppool']))
	
	file = string.replace(data, '$ethEarned', str(data['ethEarned']))
	file = string.replace(data, '$btcpEarned', str(data['btcpEarned']))
	file = string.replace(data, '$xmrEarned', str(data['xmrEarned']))
